...
<div class="card uper">
    ...
    <div class="card-body">
        ...
        @endif
        <form method="POST" action="{{ route('event_list.update', $events_list->id) }}">
        {{csrf_field()}}
        {!! method_field('put') !!}
        <div class="col-sm-4">
			...
			<button type="submit" class="btn btn-success">Create</button>
				...
				<input type="text" name="commentary" id="commentary" class="form-control select2 input-sm" value="{{ $events_list->commentary }}">
