...
<input type="hidden" name="spellDMG" id="spellDMG" class="form-control select2 input-sm" value="{{ old('spellDMG') }}">	
			<input type="hidden" name="spellAHL" id="spellAHL" class="form-control select2 input-sm" value="{{ old('spellAHL') }}">	
			
			<input type="hidden" name="components" id="components" class="form-control select2 input-sm" value="None">
                
                <label for="name">Name:</label>
				<input type="text" name="name" id="name" class="form-control select2 input-sm" value="{{ old('name') }}">

                <label for="range">Range:</label>
				<input type="number" name="range" id="range" class="form-control select2 input-sm" value="1"min="1"default="1">

				
                <label for="duration">Duration:</label>
				    <input type="text" name="duration" id="duration" class="form-control select2 input-sm" value="{{ old('duration') }}">
                <label for="description">Description:</label>
				    <input type="text" name="description" id="description" class="form-control select2 input-sm" value="{{ old('description') }}">
...
<div class="col-sm-4">
            ...
            <label for="Cdescription">Material component description:</label>
				    <input type="text" name="Cdescription" id="Cdescription" class="form-control select2 input-sm" value="{{ old('Cdescription') }}">
            </div>
		<div class="col-sm-4">
				...
				<label for="N">Spell Damage(Number of dices):</label>
				    <input type="number" name="N" id="N" class="form-control select2 input-sm" value="1" min="1"default="1">
					</br>
					</br>
				...
				<label for="NAHL">Spell Damage At higher levels (Number of dices):</label>
				    <input type="number" name="NAHL" id="NAHL" class="form-control select2 input-sm" value="1" min="1" default="1">
					<h4>Spell List</h4>
