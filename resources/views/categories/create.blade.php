	...
	<div class="card-body">
		...
		<div class="row">
			...
			<button type="submit" class="btn btn-success">Create</button>
				...
				<input type="text" name="archetype" id="archetype" class="form-control select2 input-sm" value="{{ old('archetype') }}">

				<label for="armor_prof">Armor Proficencies:</label>
				<input type="text" name="armor_prof" id="armor_prof" class="form-control select2 input-sm" value="{{ old('armor_prof') }}">

				<label for="weapon_prof">Weapon Proficencies:</label>
				<input type="text" name="weapon_prof" id="weapon_prof" class="form-control select2 input-sm" value="{{ old('weapon_prof') }}">
